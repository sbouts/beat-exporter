...
func NewApmserverCollector(beatInfo *BeatInfo, stats *Stats) prometheus.Collector {
	return &apmserverCollector{
		...
		metrics: exportedMetrics{
			...
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "closed"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "count"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "decode"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "forbidden"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "internal"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "invalidquery"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "method"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "notfound"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "queue"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "ratelimit"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "toolarge"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "unauthorized"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "unavailable"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "acm", "response"),
					"apm-server.acm.response",
					nil, prometheus.Labels{"errors": "validate"},
				),
			...
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "", "processor"),
					"apm-server.processor",
			...
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "processor", "sourcemap"),
			...
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "processor", "stream"),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "processor", "stream"),
					"apm-server.processor.stream.errors",
					nil, prometheus.Labels{"errors": "invalid"},
				),
			...
			},
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "processor", "stream"),
					"apm-server.processor.stream.errors",
					nil, prometheus.Labels{"errors": "server"},
				),
			...
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "profile", "response"),
			...
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "root", "response"),
			...
			{
				desc: prometheus.NewDesc(
					prometheus.BuildFQName(beatInfo.Beat, "server", "response"),
